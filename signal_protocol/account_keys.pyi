...
class AccountEntropyPool:
    @staticmethod
    def generate() -> AccountEntropyPool: ...

class BackupId:
    def __init__(self, data: bytes) -> None: ...
    def serialize(self) -> str: ...
    @staticmethod
    def deserialize(compressed: bytes) -> BackupId: ...

class BackupKey:
    def __init__(self, data: bytes) -> None: ...
    @staticmethod
    def derive_from_master_key(master_key: bytes) -> BackupKey: ...
    def derive_backup_id(self, aci: bytes) -> BackupId: ...
    def serialize(self) -> str: ...
    @staticmethod
    def deserialize(compressed: bytes) -> BackupKey: ...
