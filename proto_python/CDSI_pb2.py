...
ClientResponse = _reflection.GeneratedProtocolMessageType(
    "ClientResponse",
    (_message.Message,),
    {
...
EnclaveLoad = _reflection.GeneratedProtocolMessageType(
    "EnclaveLoad",
    (_message.Message,),
    {
...
ClientHandshakeStart = _reflection.GeneratedProtocolMessageType(
