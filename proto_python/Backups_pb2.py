...
SqlStatement = _reflection.GeneratedProtocolMessageType(
    "SqlStatement",
    (_message.Message,),
    {
        "SqlParameter": _reflection.GeneratedProtocolMessageType(
            "SqlParameter",
            (_message.Message,),
            {
...
SharedPreference = _reflection.GeneratedProtocolMessageType(
    "SharedPreference",
    (_message.Message,),
    {
...
DatabaseVersion = _reflection.GeneratedProtocolMessageType(
    "DatabaseVersion",
    (_message.Message,),
    {
...
BackupFrame = _reflection.GeneratedProtocolMessageType(
    "BackupFrame",
    (_message.Message,),
    {
