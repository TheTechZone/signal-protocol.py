...
_SESSIONSTRUCTURE_PENDINGKYBERPREKEY = _SESSIONSTRUCTURE.nested_types_by_name['PendingKyberPreKey']
...
SessionStructure = _reflection.GeneratedProtocolMessageType('SessionStructure', (_message.Message,), {
  ...
  'PendingKyberPreKey' : _reflection.GeneratedProtocolMessageType('PendingKyberPreKey', (_message.Message,), {
